<x-layout>
        ...
        <article class="bg-gray-800 rounded-lg w-full max-w-lg p-8">
            ...
            <form method="POST" action="{{ route('portfolio.benefits.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" placeholder="Enter benefit title" value="{{ old('title') }}"
                        required
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($benefits as $benefit)
            <article
                class="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:bg-gray-700 transition-colors duration-200">
